...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    setTimeout(() => {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_0__.closeModal)('.close');
    }, 4000);
  }
}
...
function modal(triggerSelecton, modalSelector, modalTimerId) {
  // Modal

  const modalTrigger = document.querySelectorAll(triggerSelecton),
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-08-11');
});
